...
export default function Maintenance({ message }: MaintenancePageProps) {
    return (
        <>
            <Head title="Website Sedang dalam Pemeliharaan" />
            ...
            <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 flex items-center justify-center p-4">
                ...
                <div className="w-full max-w-2xl relative">
                    ...
                    <div className="bg-white rounded-2xl shadow-2xl p-6 sm:p-8 md:p-12 text-center">
                        {/* Maintenance Icon & Code */}
                        <div className="mb-6 sm:mb-8">
                            <div className="relative inline-block">
                                <div className="w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 bg-gradient-to-br from-orange-100 to-red-100 rounded-full flex items-center justify-center mx-auto mb-6 animate-pulse">
                                    <svg className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 text-orange-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                                    </svg>
                                </div>
                                <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 bg-gradient-to-r from-orange-600 to-red-600 text-white px-4 sm:px-6 py-1.5 sm:py-2 rounded-full font-bold text-xl sm:text-2xl shadow-lg">
                                    Maintenance
                                </div>
                            </div>
                        </div>
                        ...
                        {/* Maintenance Message */}
                        <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-3 sm:mb-4">Website Sedang Dalam Pemeliharaan</h1>
                        <p className="text-sm sm:text-base md:text-lg text-gray-600 mb-6 sm:mb-8 max-w-md mx-auto px-4">
                            {message}
                        </p>

                        {/* Status Box */}
                        <div className="bg-gradient-to-r from-orange-50 to-red-50 rounded-xl p-4 sm:p-6 mb-6 sm:mb-8 max-w-md mx-auto border-l-4 border-orange-600">
                            <div className="flex items-center justify-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                                <svg className="w-5 h-5 sm:w-6 sm:h-6 text-orange-600 animate-spin" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
                            ...
                            <a
                                href="mailto:support@adraresearch.com"
                        ...
                        <div className="mt-12 pt-8 border-t border-gray-200">
                            <p className="text-sm text-gray-500">
                                Kami sedang meningkatkan sistem untuk memberikan layanan terbaik kepada Anda
                            </p>
                        </div>
                    </div>
                </div>
