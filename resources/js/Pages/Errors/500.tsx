                    ...
                    <div className="bg-white rounded-2xl shadow-2xl p-6 sm:p-8 md:p-12 text-center">
                        ...
                        <div className="mb-6 sm:mb-8">
                            <div className="relative inline-block">
                                <div className="w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 bg-gradient-to-br from-red-100 to-pink-100 rounded-full flex items-center justify-center mx-auto mb-6">
                                    <svg className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 text-red-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                                    </svg>
                                </div>
                                <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 bg-gradient-to-r from-red-600 to-pink-600 text-white px-4 sm:px-6 py-1.5 sm:py-2 rounded-full font-bold text-xl sm:text-2xl shadow-lg">
                                    500
                                </div>
                            </div>
                        </div>
                        ...
                        {/* Error Message */}
                        <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-3 sm:mb-4">Server Error</h1>
                        ...
                        <div className="mt-8 sm:mt-12 pt-6 sm:pt-8 border-t border-gray-200">
                            <p className="text-sm text-gray-600 mb-4">If the problem persists, please contact support</p>
                            <div className="flex flex-wrap gap-3 justify-center">
                                ...
                                <span className="text-gray-300">•</span>
                                <a href="https://twitter.com/adraresearch" className="text-sm text-blue-600 hover:text-blue-700 font-medium">
                                    Status Updates
                                </a>
                            </div>
                        </div>
