                    ...
                    <div className="bg-white rounded-2xl shadow-2xl p-6 sm:p-8 md:p-12 text-center">
                        ...
                        <div className="mb-6 sm:mb-8">
                            <div className="relative inline-block">
                                <div className="w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 bg-gradient-to-br from-red-100 to-orange-100 rounded-full flex items-center justify-center mx-auto mb-6">
                                ...
                                <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 bg-gradient-to-r from-red-600 to-orange-600 text-white px-4 sm:px-6 py-1.5 sm:py-2 rounded-full font-bold text-xl sm:text-2xl shadow-lg">
                                    403
                                </div>
                            </div>
                        </div>
                        ...
                        {/* Error Message */}
                        <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-3 sm:mb-4">Access Forbidden</h1>
                        <p className="text-sm sm:text-base md:text-lg text-gray-600 mb-6 sm:mb-8 max-w-md mx-auto px-4">
                            Sorry, you don't have permission to access this resource. Please contact the administrator if you believe this is an error.
                        </p>
