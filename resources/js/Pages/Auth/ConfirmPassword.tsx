...
export default function ConfirmPassword() {
    ...
    return (
        <>
            <Head title="Confirm Password - Adra Research Theme" />
                ...
                <div className="w-full max-w-md relative">
                    ...
                    <div className="bg-white rounded-xl sm:rounded-2xl shadow-2xl p-6 sm:p-8">
                        <div className="text-center mb-6 sm:mb-8">
                            ...
                            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">Secure Area</h1>
                            <p className="text-sm sm:text-base text-gray-600 px-2">This is a secure area of the application. Please confirm your password before continuing.</p>
                        </div>
