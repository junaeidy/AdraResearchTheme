...
export default function ResetPassword({
    ...
    return (
        <>
            <Head title="Reset Password - Adra Research Theme" />
                ...
                <div className="w-full max-w-md relative">
                    ...
                    <div className="bg-white rounded-xl sm:rounded-2xl shadow-2xl p-6 sm:p-8">
                        <div className="text-center mb-6 sm:mb-8">
                            ...
                            <p className="text-sm sm:text-base text-gray-600 px-2">Enter your email and new password to reset your account password.</p>
                        </div>
