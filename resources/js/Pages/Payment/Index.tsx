                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-[15px] text-blue-100 mt-1">Order #{order.order_number}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid lg:grid-cols-3 gap-6">
                        ...
                        <div className="lg:col-span-2">
                            <form onSubmit={handleSubmit} className="bg-white rounded-2xl border border-gray-200 shadow-lg p-6 space-y-6">
                                ...
                                <div className="border-t pt-6">
                                    <div className="flex items-center gap-3 mb-6 pb-4 border-b border-gray-200">
                                        ...
                                        <h3 className="text-[20px] font-bold text-gray-900" style={{fontFamily: 'NexusSansWebPro'}}>
                                            Transfer Details
                                        </h3>
                                    </div>
                                    ...
                                    <div className="grid md:grid-cols-2 gap-4">
                                        <div>
                                            <label className="block text-[14px] font-bold text-gray-900 mb-2">Your Bank Name *</label>
                                            <input
                                                id="bank_name"
                                                type="text"
                                        ...
                                        <div>
                                            <label className="block text-[14px] font-bold text-gray-900 mb-2">Your Account Number *</label>
                                            <input
                                                id="account_number"
                                                type="text"
                                        ...
                                        <div>
                                            <label className="block text-[14px] font-bold text-gray-900 mb-2">Your Account Name *</label>
                                            <input
                                                id="account_name"
                                                type="text"
                                        ...
                                        <div>
                                            <label className="block text-[14px] font-bold text-gray-900 mb-2">Transfer Date *</label>
                                            <input
                                                id="transfer_date"
                                                type="date"
                                        ...
                                        <div className="md:col-span-2">
                                            <label className="block text-[14px] font-bold text-gray-900 mb-2">Transfer Amount *</label>
                                ...
                                <div className="border-t pt-6">
                                    <button
                                        ...
                                        className="w-full px-8 py-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-[18px] font-bold rounded-xl hover:shadow-xl hover:scale-105 transition-all duration-200 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 flex items-center justify-center gap-2"
                                    >
                                        {processing ? (
                                            <>
                                    ...
                                    {!isFormValid && (
                                        <p className="text-[13px] text-red-600 font-medium mt-3 text-center">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-gradient-to-br from-white to-blue-50/30 rounded-2xl border-2 border-blue-200 shadow-lg p-6">
                                ...
                                <div className="mt-5 pt-5 border-t-2 border-blue-200">
                                    <p className="font-bold text-[14px] text-gray-900 mb-3">Items ({order.items?.length || 0}):</p>
                                    <ul className="space-y-2">
                                        {order.items?.map((item) => (
                                            <li key={item.id} className="flex justify-between items-start bg-blue-50 p-2 rounded-lg">
                                                <span className="truncate text-[13px] text-gray-700 font-medium">{item.product_name}</span>
                                                <span className="ml-2 flex-shrink-0 text-[13px] font-bold text-blue-600">
