                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-[15px] text-blue-100 mt-1">Please review your order details before proceeding to payment</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            ...
                            <div className="lg:col-span-2 space-y-6">
                                ...
                                <div className="bg-white rounded-2xl border border-gray-200 shadow-lg p-6">
                                    ...
                                    <div className="bg-gradient-to-br from-gray-50 to-blue-50/30 rounded-xl p-5 mb-5 max-h-64 overflow-y-auto border border-gray-200">
                                        <div className="text-[14px] text-gray-700 space-y-3 leading-relaxed">
                                            <p className="font-bold text-[15px] text-gray-900">License Agreement</p>
                                    ...
                                    <div className="flex items-start gap-3 bg-blue-50 p-4 rounded-xl border border-blue-200">
                                        <input
                                            ...
                                            className="mt-1 w-5 h-5 rounded-md border-2 border-gray-300 text-blue-600 focus:ring-2 focus:ring-blue-500"
                                        />
                                        <label htmlFor="terms" className="text-[14px] text-gray-700 font-medium leading-relaxed">
                            ...
                            <div className="lg:col-span-1">
                                <div className="sticky top-6">
                                    ...
                                    <button
                                        ...
                                        className="w-full mt-6 px-8 py-5 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-bold text-[18px] rounded-xl hover:shadow-2xl hover:scale-105 focus:outline-none focus:ring-4 focus:ring-blue-300 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 transition-all duration-200 shadow-lg flex items-center justify-center gap-3"
                                    >
                                        {isSubmitting ? (
                                            <>
                                    ...
                                    <p className="text-[12px] text-gray-600 text-center mt-4 font-medium">
