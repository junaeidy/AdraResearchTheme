...
export default function ProductPricing({ product, licenseTypes }: ProductPricingProps) {
    ...
    return (
        <div className="bg-gradient-to-br from-white to-blue-50/30 rounded-2xl border-2 border-blue-200 p-6 shadow-lg space-y-6">
            {/* Price Display */}
            <div className="pb-6 border-b border-blue-200">
                <div className="flex items-baseline gap-2">
                    <span className="text-[40px] font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">
                        {formatRupiah(price)}
                    </span>
                ...
                {product.sale_price && (
                    <div className="mt-3">
                        <span className="inline-flex items-center gap-1.5 bg-gradient-to-r from-green-500 to-emerald-500 text-white text-[12px] font-bold px-3 py-1.5 rounded-full shadow-md">
            ...
            <div className="space-y-3">
                ...
                <div className="flex items-center gap-3">
                    <button
                        ...
                        disabled={quantity <= 1}
                        className="w-11 h-11 rounded-xl border-2 border-gray-300 hover:border-blue-600 hover:bg-blue-50 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:border-gray-300 disabled:hover:bg-transparent font-bold text-gray-700 transition-all duration-200"
                    >
                        -
                    </button>
                    <input
                        ...
                        className="w-20 text-center border-2 border-gray-300 rounded-xl py-2.5 font-bold text-[15px] focus:border-blue-600 focus:ring-2 focus:ring-blue-200 transition-all"
                    />
                    <button
            ...
            {/* Total Price */}
            {quantity > 1 && (
                <div className="flex justify-between items-center text-[14px] pt-4 border-t border-blue-200">
                    <span className="text-gray-600 font-semibold">Total:</span>
                    <span className="text-[22px] font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">
            ...
            <PrimaryButton
                ...
                disabled={isAdding}
                className="w-full py-4 text-lg font-semibold justify-center bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-[16px]"
            >
                {isAdding ? (
